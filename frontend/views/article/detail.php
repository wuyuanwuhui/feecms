...
<div class="bg-game" id="detailPage">
    <div class="wrapper wrapper--narrow container" style="padding-top: 1rem">
            ...
            <div class=" ">
                <div class="row content-head">
                    <div class="col-xs-7 col-md-7 content-head-left clearfix">
                        <div class="game-icon">
                            <img
                                    src="http://images.6263game.com/gameicon/无人星空20200810icon.png"
                            />
                        </div>
                        <div class="titles">
                            <ul class="titles-details">
                                <li style="margin-bottom: 30px">
                                    <h5 style="font-weight: bold">无人星空</h5>
                                </li>
                                <li>
                                ...
                                <li>
                                    <ul class="list-inline game-details">
                                        <li>下载次数：<span>0次</span></li>
                                        <li>更新时间：<span>2020-08-10</span></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="content-block detail-content-floor1">
            <div><h5 class="images-title">无人星空截图</h5></div>
            <br />
            <div
            ...
            >
                <ul class="slider" style="position: relative; left: 0px">
                    ...
                    <li>
                        <img
                                src="http://images.6263game.com/gameimg/无人星空2020081001.jpg"
                        />
                    </li>
                    <li>
                        <img
                                src="http://images.6263game.com/gameimg/无人星空2020081002.jpg"
                        />
                    </li>
                    <li>
                        <img
                                src="http://images.6263game.com/gameimg/无人星空2020081003.jpg"
                        />
                    </li>
                    <li>
                        <img
                                src="http://images.6263game.com/gameimg/无人星空2020081004.jpg"
                        />
                    </li>
                    <li>
                        <img
                                src="http://images.6263game.com/gameimg/无人星空2020081005.jpg"
                        />
                    </li>
                </ul>
            </div>
